...
<body class="sb-nav-fixed">
    ...
    <?php include_once('../views/panelAdministrador/BarraNavegacionAdmin.php') ?>

    <div id="layoutSidenav">

        <!-- Importamos la barra de navegación izquierda -->
        <?php include_once('../views/panelAdministrador/BarraNavegacionIzquierda.php') ?>
            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    switch ($action) {
                        ...
                        $cuentaController->tablaMostrarUsuarios();
                    break;
